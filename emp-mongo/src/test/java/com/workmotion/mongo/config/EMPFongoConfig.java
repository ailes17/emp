...
@Configuration
@ComponentScan(basePackageClasses= {MongoServiceImpl.class, EmployeeRepository.class}, excludeFilters={@ComponentScan.Filter(type=FilterType.ASSIGNABLE_TYPE, value=MongoConfig.class)})
